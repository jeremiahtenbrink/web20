...
class StudentInfo extends React.Component{
    ...
    render(){
        ...
        return ( <div>
            <h5><Input name={ "firstName" } value={ firstName }
                       placeHolder={ "First Name..." }/></h5>
            <h5><Input name={ "lastName" } value={ lastName }
                       placeHolder={ "Last Name..." }/></h5>
            <h5><Input name={ "github" } value={ github }
                       placeHolder={ "Github Url..." }/></h5>
        </div> );
    }
}
