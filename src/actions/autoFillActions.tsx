...
import { TASInterface } from "../types/TASInterface";
...
export const updateTa = ( ta: TASInterface ) => dispatch => {
...
export const deleteTa = ( ta: TASInterface ) => dispatch => {
...
export const addTa = ( ta: TASInterface ) => dispatch => {
