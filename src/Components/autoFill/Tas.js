...
import {Button, Checkbox, Col, Icon, Input, Modal, Popconfirm, Row, Table, Form} from "antd";
...
class Tas extends Component {
    ...
    updateTA = () => {
        ...
        this.setState({firstName: "", lastName: '', cohort: '', selectedId: null, modalOpen: false});
    };
    ...
    render() {
        return (<>
                ...
                <Modal
                    title={this.state.selectedId ? `Update TA` :
                        "Add" + " TA"}
                    visible={this.state.modalOpen}
                    okText={this.state.selectedId ? "Update TA" :
                        "Add TA"}
                    onOk={this.state.selectedId ? this.updateTA :
                        this.addTA}
                    ...
                    <Row type="flex" gutter={24}>
                        <Col xs={24} md={12}>
                            ...
                            <h3>
                                <span style={{color: "#f5222d"}}>*</span> Cohort
                            </h3>
                            <Form.Item>
                                <Input
                                    style={{width: "100%"}}
