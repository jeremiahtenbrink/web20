...
class Student extends Component {
  ...
  componentWillUpdate(nextProps, nextState, nextContext) {
    ...
    if (
      !nextState.changingSelectedStudent &&
    ...
    if (nextState.changingSelectedStudent && nextProps.selectedStudent) {
      ...
      this.props.getStudentLessons(nextProps.selectedStudent, nextProps.uid);
    }
  }
  ...
  completeLesson = lesson => {
    ...
    this.props.completeStudentLesson(student, this.props.uid, studentLesson);
  };
