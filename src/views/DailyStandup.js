...
import {
    Container, Row, Form, Col, Input, Button, Table, Label,
} from "reactstrap";
                ...
                <Col md={ 6 } className="text-center overflow-scroll">
                    ...
                    <Form>
                        ...
                        <Input
                            ...
                            onChange={ this.onChange }>
                            <option value={ 1 }>1 - Did not meet
                                expectations
                            </option>
                            <option value={ 2 }>2 - Met expectations
                            </option>
                            <option value={ 3 }>3 - Exceeded expectations
                            </option>
                        </Input>
                        <br/>
                        <Input
