...
import {
    Form, FormGroup, Label, Input, Button, Row, Col, Container,
} from "reactstrap";
...
class EditUser extends Component{
    state = {
        firstName: "", lastName: "", cohort: "", loaded: false,
    };
...
const mpts = state => ( {
    user: state.auth.user, uid: state.auth.uid,
} );

export default connect( mpts, { editUser }, )( EditUser );
